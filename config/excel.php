...
return array(
    ...
    'properties' => [
        'creator'        => env('EXCEL_DESCRIPTION','Maatwebsite'),
        'lastModifiedBy' => env('EXCEL_DESCRIPTION','Maatwebsite'),
        'title'          => env('EXCEL_DESCRIPTION','Spreadsheet'),
        'description'    => env('EXCEL_DESCRIPTION','Default spreadsheet export'),
        'subject'        => env('EXCEL_DESCRIPTION','Spreadsheet export'),
        'keywords'       => env('EXCEL_KEYWORDS','maatwebsite, excel, export'),
        'category'       => env('EXCEL_DESCRIPTION','Excel'),
        'manager'        => env('EXCEL_DESCRIPTION','Maatwebsite'),
        'company'        => env('EXCEL_DESCRIPTION','Maatwebsite'),
    ],
